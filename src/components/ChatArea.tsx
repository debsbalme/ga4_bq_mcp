      ...
      <div className="flex-1 overflow-y-auto p-4 sm:p-8 space-y-6">
        <div className="max-w-4xl mx-auto space-y-6">
          {!isAuthenticated && onOpenAuthModal && (
            <div className="p-4 sm:p-5 rounded-2xl bg-blue-50/80 border border-blue-200/90 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 shadow-2xs">
              <div className="space-y-1">
                ...
                <p className="text-xs text-blue-800">
                  {isBigQueryEnabled 
                    ? 'Sign in with Google to query and explore your live GA4 properties and BigQuery datasets'
                    : 'Sign in with Google to query and explore your live GA4 properties'}
                </p>
              </div>
              <button
                onClick={onOpenAuthModal}
                className="px-4 py-2 bg-slate-900 hover:bg-slate-800 text-white rounded-xl text-xs font-bold shadow-xs shrink-0 cursor-pointer transition-colors"
              >
                Sign in with Google
              </button>
            </div>
