      ...
      <div className="flex items-center gap-2 sm:gap-4">
        ...
        <div className="hidden lg:flex items-center gap-1.5">
          {isBigQueryEnabled && onOpenBigQueryStudio && (
            <button
              onClick={onOpenBigQueryStudio}
              className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg text-xs font-semibold text-indigo-700 bg-indigo-50/70 border border-indigo-200 hover:bg-indigo-100 transition-colors cursor-pointer"
            >
        ...
        >
          <div className="text-right hidden sm:block">
            ...
            <p className="text-[10px] text-slate-500 truncate max-w-[120px]">
              {user?.email || (isBigQueryEnabled ? 'GA4 & BigQuery' : 'Google Analytics 4')}
            </p>
          </div>
